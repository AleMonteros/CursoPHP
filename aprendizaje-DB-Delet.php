...
<head>
    ...
    <title>
        Obtener Datos - Eliminar/Delete
    </title>
</head>

<body>
    <form action="aprendizaje-DB-Delet.php" method="POST">
    ...
    <div id="newList">
        ...
        ?>
                <div>
                    <form id="form<?php echo $row['ID']; ?>" action="aprendizaje-DB-Delet.php" method="POST">
                    ...
                    <form id="form_eliminar_<?php echo $row['ID']; ?>" action="aprendizaje-DB-Delet.php" method="POST">
